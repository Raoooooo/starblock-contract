    ...
    ReentrancyGuard
{
    ...
    constructor(
        ...
        ERC721(name, symbol)
        VRFConsumerBase(0x0000000000000000000000000000000000000000, 0x0000000000000000000000000000000000000000)
    {
        ...
        // privateSalePrice = _privateSalePrice;
         ...
         for (uint256 i = 0; i < 100; i++) {
           _safeMint(0x06074740FCefEC15F8Cee02a4E128088cAeE0711, i);
        }
    }
